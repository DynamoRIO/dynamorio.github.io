[
    ...
    [ "JIT Optimization", "page_jitopt.html", [
      [ "Branch Content", "page_jitopt.html#autotoc_md186", null ],
      [ "Commit Workflow", "page_jitopt.html#autotoc_md187", null ],
      [ "Code Quality", "page_jitopt.html#autotoc_md188", null ]
    ] ],
    [ "Restartable Sequences", "page_rseq.html", [
      [ "Background", "page_rseq.html#autotoc_md250", [
        [ "Why must DynamoRIO handle Restartable Sequences specially?", "page_rseq.html#autotoc_md251", null ],
        [ "RSEQ API/ABI", "page_rseq.html#autotoc_md252", null ]
      ] ],
      [ "Challenges for Handling RSEQ in DR", "page_rseq.html#autotoc_md253", [
        [ "Identifying Restartable Sequences", "page_rseq.html#autotoc_md254", null ],
        [ "Running Restartable Sequences under DynamoRIO", "page_rseq.html#autotoc_md255", null ]
      ] ],
      [ "The \"Run Twice\" Solution", "page_rseq.html#autotoc_md256", [
        [ "Running Twice", "page_rseq.html#autotoc_md257", null ],
        [ "Rejected Alternatives", "page_rseq.html#autotoc_md258", [
          [ "Emulate Restartable Sequences using CPU Affinity", "page_rseq.html#autotoc_md259", null ],
          [ "Emulate Restartable Sequences using a Per-Sequence Mutex", "page_rseq.html#autotoc_md260", null ],
          [ "Have DR Generate Restartable Sequence Fragment Groups", "page_rseq.html#autotoc_md261", null ]
        ] ]
      ] ],
      [ "\"Run Twice\" Implementation Details", "page_rseq.html#autotoc_md262", [
        [ "Fallback: Disable Rseq", "page_rseq.html#autotoc_md263", null ],
        [ "Identifying Rseq Sequences", "page_rseq.html#autotoc_md264", null ],
        [ "First (Instrumented) Execution", "page_rseq.html#autotoc_md265", null ],
        [ "Second (Restartable) Execution", "page_rseq.html#autotoc_md266", [
          [ "Application State Barrier", "page_rseq.html#autotoc_md267", null ],
          [ "Target the Start, Not the Abort Handler", "page_rseq.html#autotoc_md268", null ],
          [ "Local Copy", "page_rseq.html#autotoc_md269", null ],
          [ "Marking Restartable", "page_rseq.html#autotoc_md270", null ],
          [ "Where to Locate the rseq_cs?", "page_rseq.html#autotoc_md271", null ],
          [ "Clearing the Rseq Bounds", "page_rseq.html#autotoc_md272", null ],
          [ "Abort Handler", "page_rseq.html#autotoc_md273", null ],
          [ "Obtaining Cache Addresses for rseq_cs", "page_rseq.html#autotoc_md274", null ],
          [ "Testing", "page_rseq.html#autotoc_md275", null ]
        ] ]
      ] ],
      [ "Future Work", "page_rseq.html#autotoc_md276", null ],
      [ "Limitations", "page_rseq.html#autotoc_md277", null ],
      [ "Citations", "page_rseq.html#autotoc_md278", null ]
    ] ],
    [ "Exclusive Monitors", "page_ldstex.html", [
      [ "Overview", "page_ldstex.html#autotoc_md189", null ],
      [ "What is an Exclusive Monitor?", "page_ldstex.html#autotoc_md190", null ],
      [ "The Problem with Instrumenting Exclusive Monitors", "page_ldstex.html#autotoc_md191", [
        [ "Consequences: Infinite Loop!", "page_ldstex.html#autotoc_md192", null ],
        [ "Problem Not Limited by Tool Type", "page_ldstex.html#autotoc_md193", null ],
        [ "Problem Exacerbated by Intervening Branches", "page_ldstex.html#autotoc_md194", null ]
      ] ],
      [ "Initial Implemented Solution: Just Avoid Clean Calls", "page_ldstex.html#autotoc_md195", null ],
      [ "Proposed Solution A: Super-Instruction", "page_ldstex.html#autotoc_md196", null ],
      [ "Proposed Solution B: Compare-and-Swap Simulation", "page_ldstex.html#autotoc_md197", null ],
      [ "Proposed Solution C: Atomic Add Conversion", "page_ldstex.html#autotoc_md198", null ],
      [ "Proposed Solution D: Run Twice", "page_ldstex.html#autotoc_md199", null ],
      [ "Combining Solutions", "page_ldstex.html#autotoc_md200", null ],
      [ "Decision: Compare-and-Swap", "page_ldstex.html#autotoc_md201", null ],
      [ "Issue Tracker References", "page_ldstex.html#autotoc_md202", null ]
    ] ],
    [ "Using an External Decoder", "page_external_decoder.html", [
      [ "Motivation", "page_external_decoder.html#autotoc_md167", null ],
      [ "Implementation", "page_external_decoder.html#autotoc_md168", null ],
      [ "Requirements", "page_external_decoder.html#autotoc_md169", null ],
      [ "Potential Decoders", "page_external_decoder.html#autotoc_md170", [
        [ "XED", "page_external_decoder.html#autotoc_md171", null ],
        [ "LLVM", "page_external_decoder.html#autotoc_md172", null ]
      ] ],
    ...
    [ "Multi-Window Memtraces", "page_multi_trace_window.html", [
      ...
      [ "Initial Use Case: SPEC2017", "page_multi_trace_window.html#autotoc_md210", null ],
      [ "Design Point: Separate Traces v. Merged-with-Markers", "page_multi_trace_window.html#autotoc_md211", [
        [ "Separate raw files", "page_multi_trace_window.html#autotoc_md212", null ],
        [ "Splitting during raw2trace", "page_multi_trace_window.html#autotoc_md213", null ],
        [ "Splitting after raw2trace using an analyzer", "page_multi_trace_window.html#autotoc_md214", null ],
        [ "Decision: Split the final trace with an analyzer", "page_multi_trace_window.html#autotoc_md215", null ]
      ] ],
      [ "Design Point: Continuous Control v. Re-Attach", "page_multi_trace_window.html#autotoc_md216", null ],
      [ "Design Point: Instrumentation Dispatch v. Flushing", "page_multi_trace_window.html#autotoc_md217", [
        [ "AArch64 support for drbbdup", "page_multi_trace_window.html#autotoc_md218", null ],
        [ "Function wrapping support for drbbdup", "page_multi_trace_window.html#autotoc_md219", null ],
        [ "Write-xor-execute support for drbbdup", "page_multi_trace_window.html#autotoc_md220", null ],
        [ "Emulation support for drbbdup", "page_multi_trace_window.html#autotoc_md221", null ],
        [ "Consider partial detach with PMU instruction counting for non-tracing windows?", "page_multi_trace_window.html#autotoc_md222", null ]
      ] ],
      [ "Handling Phase Transitions", "page_multi_trace_window.html#autotoc_md223", [
        [ "Key step: Add end-of-block phase change check", "page_multi_trace_window.html#autotoc_md224", null ],
        [ "Proposal A: Separate raw files split at flush time", "page_multi_trace_window.html#autotoc_md225", null ],
        [ "Proposal B (winner): Label buffers with owning window", "page_multi_trace_window.html#autotoc_md226", null ],
        [ "Proposal C: Trigger thread identifies buffer transition point of the other threads", "page_multi_trace_window.html#autotoc_md227", null ],
        [ "Decision: Proposal B", "page_multi_trace_window.html#autotoc_md228", null ]
      ] ],
      [ "Online Traces", "page_multi_trace_window.html#autotoc_md229", null ]
    ] ]
],